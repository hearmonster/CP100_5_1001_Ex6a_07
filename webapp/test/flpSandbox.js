		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight Data Demo",
									"targetURL": "#FlightDataDemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FlightDataDemo-display": {
								"semanticObject": "FlightDataDemo",
								"action": "display",
								"description": "FLIGHT OData Demo App",
								"title": "Flight Data Demo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.training.CP100_5_1001_07",
									"url": sap.ui.require.toUrl("com/sap/training/CP100_5_1001_07")
								}
							}
						}
					}
